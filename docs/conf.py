...
"""
edx_poc_plugin documentation build configuration file.
...
project = 'edx_poc_plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx_poc_plugin'
...
#
# html_title = 'edx_poc_plugin v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_poc_plugin'),
                os.path.join(root_path, 'edx_poc_plugin/migrations')])
